...
class Farmaceutico:
    ...
    def receber_a_receita(self, nome_paciente: str, receita: dict) -> bool:
        ...
        self.receitas_recebidas = dict(hora_recebimento= data_hora, paciente= nome_paciente,receita= receita)
        print(f"Receita recebida: {self.receitas_recebidas}")
        return True

    def validar_receita(self, nome_paciente: str, receita: dict) -> bool:
        if nome_paciente == receita["nome_paciente"] \
